          ...
          {hasItems ? (
            ...
            <FadeIn>
              <article className="rounded-2xl border border-border bg-card p-8 text-center shadow-sm">
                <p className="text-base leading-relaxed text-muted-foreground">{t("emptyState")}</p>
                <div className="mt-6 flex justify-center">
                  <ButtonLink href={site.instagramUrl} variant="secondary" external className="min-h-[52px] px-6 text-base">
                    <InstagramGlyph className="h-5 w-5 shrink-0" aria-hidden />
                    {t("ctaSecondary")}
                  </ButtonLink>
                </div>
